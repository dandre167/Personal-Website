...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="lfa.css"> 
</head>
...
<div class="container">
  <h1 style="margin-top:25px;margin-bottom:25px;">Lfa php</h1>
  ...
  <p style="font-size:25px;text-align:center;margin: 50px 50px 50px 50px;">This is a php webpage that uses an array of
    assignments and puts it into the nav bar</p>
